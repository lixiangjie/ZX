    ...
    DatePicker.prototype = {
        ...
        FillData: function () {
            ...
            var picker_list = '<div class="zx_select showPicker">' +
                '<header><button class="nav_left picker-long">长期</button>' +
        ...
        eventClick: function () {
            ...
            //空白地方点击，取消老虎机
            document.querySelector('.zx_mask').addEventListener("touchstart", function (e) {
                //隐藏picker
                self.HidePicker();
            });

            //长期按钮
            document.querySelector('.picker-long').addEventListener("touchstart", function (e) {
                e.stopPropagation();
                e.preventDefault();
